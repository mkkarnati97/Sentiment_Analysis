...
print(colored("Creating the DNN_tfidf model", "yellow"))
model = Sequential()
...
# Training the model
print(colored("Training the DNN_tfidf model", "green"))
history = model.fit(train_tweet_vector, pd.get_dummies(train_data['Sentiment']).values, epochs = 5, batch_size = 64, verbose = 1, validation_split = 0.2)
print(colored(history, "green"))

# Testing the model
print(colored("Testing the DNN_tfidf model", "green"))
